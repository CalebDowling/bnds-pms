  ...
  useEffect(() => {
    async function loadTemplate() {
      try {
        ...
        const { template, variables: vars, defaultData } = await res.json();
      ...
      <div className="px-6 pb-6">
        ...
        <div className="bg-white rounded-lg border border-[var(--border)] p-3 mb-4 flex items-center gap-3 flex-wrap">
          <span className="text-xs text-[var(--text-muted)]">
            DRX Template #{templateMeta?.id} &middot; {variables.length} variables &middot; {categories.length} groups
          </span>
          {loading && (
