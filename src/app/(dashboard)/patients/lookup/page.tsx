      ...
      <div className="px-6 pb-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Search DRX by patient name or RX number</p>
          </div>
          <Link
            href="/patients"
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-4 mb-4">
          ...
          <p className="text-[10px] text-gray-400 mt-2">
            Searches DRX live. Enter a name to find a patient, or an RX number to find fills.
          </p>
        </form>
                        ...
                        <div className="border-t border-gray-100">
                          ...
                          <div className="px-5 py-2 bg-gray-50 border-t border-gray-100">
                            <span className="text-[10px] text-gray-400">
                              DRX Patient ID: {patient.id} &middot; Showing up to 20 recent fills
                            </span>
                          </div>
                        </div>
                      )}
        ...
        {!loading && !searched && (
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-400 text-xs">Results are fetched live from DRX</p>
          </div>
        )}
      </div>
    </div>
