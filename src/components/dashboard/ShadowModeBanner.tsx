...
export default function ShadowModeBanner() {
  ...
  return (
    <div className="relative z-40">
      {/* Top banner */}
      <div
        className="flex items-center justify-between px-3 py-1.5 text-xs cursor-pointer select-none min-w-0 overflow-hidden"
        style={{
      ...
      >
        <div className="flex items-center gap-2 min-w-0 flex-shrink">
          ...
          <span className="font-semibold tracking-wide flex-shrink-0" style={{ color: "#40721D", fontSize: "11px" }}>
            SHADOW MODE
          </span>

          <span className="opacity-70 truncate hidden sm:inline" style={{ fontSize: "11px" }}>
            Synced from DRX — read-only mirror
          </span>
        </div>
